...
class Equipacion{
    ...
    public function editarEquipacion($equipacion_modificada,$id){
          $this->db->query("UPDATE v2equipacion SET tipo=:tipo, imagen=:imagen, descripcion=:descripcion, precio=:precio WHERE id_equipacion=:id");          
          $this->db->bind(':id',$id);
    ...
    public function obtener_pedidos($temporada){
        ...
        and fecha_peticion between :inicio and :fin
        ORDER BY id_usuario");
