                ...
                <div  class="col-11 mt-5">
                        ...
                        <div class="row mt-4 mb-4">
                            ...
                            <div class="col-7">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Escriba el dni" id="dni" name="dni">
                                </div>
                            </div>                           
                        </div>
                        ...
                        <div class="row mt-3 mb-5">
                            <div class="col-12 input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Escriba la dirección" id="direccion" name="direccion" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Escriba el telefono" id="telefono" name="telefono" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required>
                                </div>
                            </div>
                            <div class="col-7">
                                <div class="input-group">
