...
<head>
    ...
    <link rel="stylesheet" href="<?php echo RUTA_URL ?>/css/estilos-tienda.css">
    ...
    <div class="container-fluid min-vh-100" style="border: solid; height: 100%;">
        <header class="p-5 row">
            ...
            <div class="col-7 text-center">
                <h1 id="titulo" style="font-family: 'Anton',sans-serif; color: #023EF9; font: bold; letter-spacing: 5px;">ZONA TIENDA</h1>
            </div>
